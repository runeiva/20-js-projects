...
//Passing JokeAPI to VoiceRSSAPI
function humourMe(joke) {
console.log('tell me:', joke);
VoiceRSS.speech({
    key: 'a1c3df179d0a4cc697e618fa0e30b078',
    src: joke,
    hl: 'en-us',
    v: 'Linda',
    r: 0, 
...
// Get Jokes API
async function getJoked() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Dark,Pun?blacklistFlags=religious';
    try {
...
// Event listener
button.addEventListener('click', getJoked);
